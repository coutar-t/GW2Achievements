...
class CategoriesGroupsListModuleFactoryTests: XCTestCase {
    func test_whenMakeView_thenIsAnInstanceOfCategoriesGroupsListViewController() {
        expect(CategoriesGroupsListModuleFactory().makeView()).to(beAnInstanceOf(CategoriesGroupsListViewController.self))
    }
}
